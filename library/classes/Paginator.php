      ...
      if ($this->elements > $this->elements_per_page) {
        if ($this->page > 0) {
          if ($this->page > 1) {
            ...
            $html .= '<li>';
              $html .= '<a href="' . str_replace('$1', 1, $url) . '"> &lt;&lt; </a>'; // first page
            $html .= '</li>';
            $html .= '<li>';
              $html .= '<a href="' . str_replace('$1', $this->page - 1, $url) . '"> &lt; </a>'; // previous page
            $html .= '</li>';
          }

          for ($i=1; $i <= $this->pages; $i++) {
            $html .= '<li>';
              $html .= '<a href="' . str_replace('$1', $i, $url) . '"';
              if ($i == $this->page) {
          ...
          if ($this->page < $this->pages) {
            ...
            $html .= '<li>';
              $html .= '<a href="' . str_replace('$1', $this->page + 1, $url) . '"> &gt; </a>'; // next page
            $html .= '</li>';
            $html .= '<li>';
              $html .= '<a href="' . str_replace('$1', $this->pages, $url) . '"> &gt;&gt; </a>'; // last page
            $html .= '</li>';
          }
        }
      }
